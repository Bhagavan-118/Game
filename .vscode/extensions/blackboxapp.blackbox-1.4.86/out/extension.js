...
function activate(_) {	
	...
	if (userId == undefined) {
		...
		// vscode.commands.executeCommand("blackbox.showChat") // dont open the right side on install
  ...
  <body style="margin:0px;padding:0px;overflow:hidden">
	...
	let statusBarBtn = vscode.window.createStatusBarItem(vscode.StatusBarAlignment.Right, 100);
	...
	if (installed_date > dateToMilliseconds('2024-12-20')){ // new install can chat with blackbox agent
		statusBarBtn.command = 'blackbox.openCybercoder'
	}
	statusBarBtn.show();
	...
	cyberCoderStatusBar.text = '👉 Code Agent';
	cyberCoderStatusBar.tooltip = 'Open Code Agent';
